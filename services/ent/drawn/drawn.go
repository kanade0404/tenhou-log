...
const (
	// Label holds the string label denoting the drawn type in the database.
	Label = "drawn"
	...
	EdgeDiscard = "discard"
	// Table holds the table name of the drawn in the database.
	Table = "drawns"
	...
	DiscardColumn = "discard_draw"
)

// Columns holds all SQL columns for drawn fields.
var Columns = []string{
	FieldID,
}

// ForeignKeys holds the SQL foreign-keys that are owned by the "drawns"

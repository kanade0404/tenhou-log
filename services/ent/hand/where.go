...
func ID(id uuid.UUID) predicate.Hand {
	return predicate.Hand(sql.FieldEQ(FieldID, id))
}
...
func ContinuePoint(v uint) predicate.Hand {
	return predicate.Hand(sql.FieldEQ(FieldContinuePoint, v))
}
...
func ReachPoint(v uint) predicate.Hand {
	return predicate.Hand(sql.FieldEQ(FieldReachPoint, v))
}

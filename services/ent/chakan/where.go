...
func ID(id uuid.UUID) predicate.Chakan {
	return predicate.Chakan(sql.FieldEQ(FieldID, id))
}
...
func IDNEQ(id uuid.UUID) predicate.Chakan {
	return predicate.Chakan(sql.FieldNEQ(FieldID, id))
}

// IDIn applies the In predicate on the ID field.
func IDIn(ids ...uuid.UUID) predicate.Chakan {
	return predicate.Chakan(sql.FieldIn(FieldID, ids...))
}

// IDNotIn applies the NotIn predicate on the ID field.
func IDNotIn(ids ...uuid.UUID) predicate.Chakan {
	return predicate.Chakan(sql.FieldNotIn(FieldID, ids...))
}

// IDGT applies the GT predicate on the ID field.
func IDGT(id uuid.UUID) predicate.Chakan {
	return predicate.Chakan(sql.FieldGT(FieldID, id))
}

// IDGTE applies the GTE predicate on the ID field.
func IDGTE(id uuid.UUID) predicate.Chakan {
	return predicate.Chakan(sql.FieldGTE(FieldID, id))
}

// IDLT applies the LT predicate on the ID field.
func IDLT(id uuid.UUID) predicate.Chakan {
	return predicate.Chakan(sql.FieldLT(FieldID, id))
}

// IDLTE applies the LTE predicate on the ID field.
func IDLTE(id uuid.UUID) predicate.Chakan {
	return predicate.Chakan(sql.FieldLTE(FieldID, id))
}
